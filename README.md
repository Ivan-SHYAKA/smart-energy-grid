...
│   ├── 02\_create\_hypertable.sql

│   ├── 03\_chunk\_tables.sql

│   ├── 04\_baseline\_queries.sql

│   ├── 05\_compression.sql

│   └── 06\_continuous\_aggregates.sql
...
│   ├── historical\_loader.py

│   └── dashboard.py

└── report/

&#x20;   └── Smart\_Energy\_Grid\_Technical\_Report.docx
...
3\. pip install paho-mqtt psycopg2-binary dash plotly pandas sqlalchemy
